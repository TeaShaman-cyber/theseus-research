...
| [`theseus-session-search-lab`](https://github.com/TeaShaman-cyber/theseus-session-search-lab) | public · bootstrapping | Portable, verifiable session-history capture/import and historical search experiments |
